...
if false then
	local common = { --[[@class js_common_namespace]]
		...
		String = {
			...
			replace = 0, --[[@type fun(self: js_string, pattern: js_string_like|js_regexp, replacement: js_string_like|fun(match:string,...:string):string): js_string]]
			--[[`pattern` also accepts `{[@@replace]:fun()}`]]
	...
	local browser = { --[[@class js_browser_namespace: js_common_namespace]]
		...
		CloseEvent = { --[[@class js_dom_close_event: js_dom_event]]
			new = 0, --[[@type fun(type: "close"|js_string, options?: {wasClean?:js_boolean_like;code?:js_integer_like;reason?:js_string_like;bubbles?:js_boolean_like;cancelable?:js_boolean_like;composed?:js_boolean_like;}): js_dom_close_event]]
			code = 0, --[[@type js_number]] --[[integer]]
			reason = 0, --[[@type js_string]]
			wasClean = 0, --[[@type js_boolean]]
		},
		--[[@alias js_message_event_source js_window_proxy|js_message_port|js_service_worker]]

		--[[https://developer.mozilla.org/en-US/docs/Web/API/MessageEvent  ]]
		MessageEvent = { --[[@class js_dom_message_event: js_dom_event]]
			new = 0, --[[@type fun(type: "message"|js_string, options?: {data?:unknown;origin?:js_string_like;lastEventId?:js_string_like;source?:js_message_event_source;ports?:js_message_port[];bubbles?:js_boolean_like;cancelable?:js_boolean_like;composed?:js_boolean_like;}): js_dom_message_event]]
			data = 0, --[[@type unknown]]
			lastEventId = 0, --[[@type js_string]]
			origin = 0, --[[@type js_string]]
			ports = 0, --[[@type js_message_port[] ]]
			source = 0, --[[@type js_message_event_source]]
		},
		...
		DOMTokenList = { --[[@class js_dom_token_list: {[integer]:string}]]
			length = 0, --[[@type js_number]] --[[read-only]]
			value = 0, --[[@type js_string]] --[[read-only]]
			add = 0, --[[@type fun(self: js_dom_token_list, token: js_string_like, ...: js_string_like)]]
			contains = 0, --[[@type fun(self: js_dom_token_list, token: js_string_like): js_boolean]]
			entries = 0, --[[@type fun(self: js_dom_token_list): (fun(): {[0]:js_number,[1]:js_string})]] --[[returns an iterator]]
			forEach = 0, --[[@type fun(self: js_dom_token_list, callback: (fun(currentValue: js_string, currentIndex: js_number)), thisArg?: unknown)]]
			item = 0, --[[@type fun(self: js_dom_token_list, index: js_integer_like): js_string|nil]]
			keys = 0, --[[@type fun(self: js_dom_token_list): (fun(): js_number)]] --[[returns an iterator]]
			remove = 0, --[[@type fun(self: js_dom_token_list, token: js_string_like, ...: js_string_like)]]
			replace = 0, --[[@type fun(self: js_dom_token_list, oldToken: js_string_like, newToken: js_string_like)]]
			supports = 0, --[[@type fun(self: js_dom_token_list, token: js_string_like): js_boolean]]
			--[[toggles by default; removes if `force` is `false`; adds if `force` is `true`]]
			toggle = 0, --[[@type fun(self: js_dom_token_list, token: js_string_like, force?: js_boolean_like)]]
			values = 0, --[[@type fun(self: js_dom_token_list): (fun(): js_string)]] --[[returns an iterator]]
			--
		},
		...
		Document = { --[[@class js_dom_document: js_dom_node]]
			...
			getElementById = 0, --[[@type fun(self: js_dom_document, id: js_string_like): js_dom_html_element|nil]] --[[may return `js_dom_element` too]]
		...
		Element = { --[[@class js_dom_element: js_dom_node]]
			...
			classList = 0, --[[@type js_dom_token_list]]
			--[[IMPL]]
		...
		WebSocket = { --[[@class js_web_socket]]
			new = 0, --[[@type fun(url: js_string_like, protocols?: js_string_like|js_string_like[]): js_web_socket]]
			binaryType = 0, --[[@type "blob"|"arraybuffer"|js_string]]
			bufferedAmount = 0, --[[@type js_number]] --[[integer]]
			extensions = 0, --[[@type js_string]]
			protocol = 0, --[[@type js_string]]
			readyState = 0, --[[@type 0|1|2|3|js_number]]
			url = 0, --[[@type js_string]]
			--[[`reason` must be no longer than 123 bytes when encoded in utf-8]]
			close = 0, --[[@type fun(self: js_web_socket, code?: js_integer_like, reason?: js_string_like)]]
			send = 0, --[[@type fun(self: js_web_socket, data: js_string_like|js_array_buffer|js_blob|js_typed_array|js_data_view)]]
			--[[@overload fun(self: js_web_socket, type: "close", listener: (fun(event:js_dom_close_event)), useCapture: js_boolean_like)]]
			--[[@overload fun(self: js_dom_element, type: "error", listener: (fun(event:js_dom_event)), options?: {capture?:js_boolean_like;once?:js_boolean_like;passive?:js_boolean_like;signal?:js_dom_abort_signal;})]]
			--[[@overload fun(self: js_dom_element, type: "error", listener: (fun(event:js_dom_event)), useCapture: js_boolean_like)]]
			--[[@overload fun(self: js_dom_element, type: "message", listener: (fun(event:js_dom_message_event)), options?: {capture?:js_boolean_like;once?:js_boolean_like;passive?:js_boolean_like;signal?:js_dom_abort_signal;})]]
			--[[@overload fun(self: js_dom_element, type: "message", listener: (fun(event:js_dom_message_event)), useCapture: js_boolean_like)]]
			--[[@overload fun(self: js_dom_element, type: "open", listener: (fun(event:js_dom_event)), options?: {capture?:js_boolean_like;once?:js_boolean_like;passive?:js_boolean_like;signal?:js_dom_abort_signal;})]]
			--[[@overload fun(self: js_dom_element, type: "open", listener: (fun(event:js_dom_event)), useCapture: js_boolean_like)]]
			--[[@param self js_web_socket]] --[[@param type "close"]] --[[@param listener fun(event:js_dom_close_event)]] --[[@param options? {capture?:js_boolean_like;once?:js_boolean_like;passive?:js_boolean_like;signal?:js_dom_abort_signal;})]]
			addEventListener = function (self, type, listener, options) end,
			--[[@overload fun(self: js_web_socket, type: "close", listener: (fun(event:js_dom_close_event)), useCapture: js_boolean_like)]]
			--[[@overload fun(self: js_dom_element, type: "error", listener: (fun(event:js_dom_event)), options?: {capture?:js_boolean_like;})]]
			--[[@overload fun(self: js_dom_element, type: "error", listener: (fun(event:js_dom_event)), useCapture: js_boolean_like)]]
			--[[@overload fun(self: js_dom_element, type: "message", listener: (fun(event:js_dom_message_event)), options?: {capture?:js_boolean_like;})]]
			--[[@overload fun(self: js_dom_element, type: "message", listener: (fun(event:js_dom_message_event)), useCapture: js_boolean_like)]]
			--[[@overload fun(self: js_dom_element, type: "open", listener: (fun(event:js_dom_event)), options?: {capture?:js_boolean_like;})]]
			--[[@overload fun(self: js_dom_element, type: "open", listener: (fun(event:js_dom_event)), useCapture: js_boolean_like)]]
			--[[@param self js_web_socket]] --[[@param type "close"]] --[[@param listener fun(event:js_dom_close_event)]] --[[@param options? {capture?:js_boolean_like;})]]
			removeEventListener = function (self, type, listener, options) end,
		},
		...
		URLSearchParams = { --[[@class js_url_search_params]]
			new = 0, --[[@type fun(options?: js_string_like|{[0]:js_string_like;[1]:js_string_like;}[]|table<js_string_like,js_string_like>|js_form_data): js_url_search_params]]
			...
			entries = 0, --[[@type fun(self: js_url_search_params): (fun(): {[0]:js_string_like;[1]:js_string_like;})]] --[[returns an iterator]]
		...
		AbortSignal = { --[[@class js_dom_abort_signal: js_dom_event_target]]
			...
			--[[@overload fun(self: js_dom_abort_signal, type: "abort", listener: (fun(event:js_dom_event)), useCapture: js_boolean_like)]]
			--[[@param self js_dom_abort_signal]] --[[@param type "abort"]] --[[@param listener fun(event:js_dom_event)]] --[[@param options? {capture?:js_boolean_like;once?:js_boolean_like;passive?:js_boolean_like;signal?:js_dom_abort_signal;})]]
			addEventListener = function (self, type, listener, options) end,
			--[[@overload fun(self: js_dom_abort_signal, type: "abort", listener: (fun(event:js_dom_event)), useCapture: js_boolean_like)]]
			--[[@param self js_dom_abort_signal]] --[[@param type "abort"]] --[[@param listener fun(event:js_dom_event)]] --[[@param options? {capture?:js_boolean_like;})]]
			removeEventListener = function (self, type, listener, options) end,
		},
		--[[https://developer.mozilla.org/en-US/docs/Web/API/MessagePort  ]]
		MessagePort = { --[[@class js_message_port]]
			close = 0, --[[@type fun(self: js_message_port)]]
			postMessage = 0, --[[@type fun(message: unknown, transferList?: unknown[])]] --[[`message` can be of any basic data type]]
			start = 0, --[[@type fun(self: js_message_port)]]
			--[[@overload fun(self: js_dom_abort_signal, type: "message", listener: (fun(event:js_dom_message_event)), useCapture: js_boolean_like)]]
			--[[@overload fun(self: js_dom_abort_signal, type: "messageerror", listener: (fun(event:js_dom_message_event)), options?: {capture?:js_boolean_like;once?:js_boolean_like;passive?:js_boolean_like;signal?:js_dom_abort_signal;})]]
			--[[@overload fun(self: js_dom_abort_signal, type: "messageerror", listener: (fun(event:js_dom_message_event)), useCapture: js_boolean_like)]]
			--[[@param self js_dom_abort_signal]] --[[@param type "message"]] --[[@param listener fun(event:js_dom_message_event)]] --[[@param options? {capture?:js_boolean_like;once?:js_boolean_like;passive?:js_boolean_like;signal?:js_dom_abort_signal;})]]
			addEventListener = function (self, type, listener, options) end,
			--[[@overload fun(self: js_dom_abort_signal, type: "message", listener: (fun(event:js_dom_message_event)), useCapture: js_boolean_like)]]
			--[[@overload fun(self: js_dom_abort_signal, type: "messageerror", listener: (fun(event:js_dom_message_event)), options?: {capture?:js_boolean_like;}))]]
			--[[@overload fun(self: js_dom_abort_signal, type: "messageerror", listener: (fun(event:js_dom_message_event)), useCapture: js_boolean_like)]]
			--[[@param self js_dom_abort_signal]] --[[@param type "message"]] --[[@param listener fun(event:js_dom_message_event)]] --[[@param options? {capture?:js_boolean_like;})]]
			removeEventListener = function (self, type, listener, options) end,
		},
