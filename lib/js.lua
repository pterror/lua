...
if false then
	...
	local browser = { --[[@class js_browser_namespace: js_common_namespace]]
		...
		Node = { --[[@class js_dom_node: js_dom_event_target]]
			...
			appendChild = 0, --[[@type fun(self: js_dom_node, aChild: js_dom_node): js_dom_node]]
			...
			replaceChild = 0, --[[@type fun(self: js_dom_node, newChild: js_dom_node, oldChild: js_dom_node): js_dom_node]] --[[returns `oldChild`]]
		...
		Document = { --[[@class js_dom_document: js_dom_node]]
			...
			body = 0, --[[@type js_dom_html_body_element|js_dom_html_frameset_element|nil]]
