...
local ft = require("dep.glua.lib.ft")
local iconv = require("dep.glua.lib.iconv")
local ic = iconv.open("UCS-2LE", "UTF-8")

local gui = {}

--[[@class glua_font_face]]
--[[@field glyph unknown]]

--[[@class glua_font_map]]

--[[@class glua_font]]
--[[@field face glua_font_face]]
--[[@field map glua_font_map]]
--[[@field lcd boolean]]
--[[@field texdim integer]]
--[[@field x number]]
--[[@field y number]]
--[[@field maxheight number]]
--[[@field size integer]]

local font = {} --[[@class glua_font]]
local fontMT = { __index = font }

gui.font = function (self)
	self = self or {}
...
font.array = function (self, program, str, width)
	width = width or 1e20
